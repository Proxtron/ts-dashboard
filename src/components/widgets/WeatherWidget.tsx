...
import { Wind, Droplet, Eye, MapPinPlus, Grip } from "lucide-react";
...
const WeatherWidget = ({ widgetId, setActivatorNodeRef, listeners }: WeatherWidgetProps) => {
    ...
    const WeatherIcon = getWeatherIcon(weatherNow.weatherCode);
    const weatherDescription = getWeatherDescription(weatherNow.weatherCode);
    const [accentDefault, textSecondary, borderDefault] = useToken("colors", ["accent.default", "text.secondary", "border.default"])

    return (
        <Card.Root w="380px" minH="420px" >
            ...
            <Card.Footer justifyContent="space-between">
                ...
                <Button ref={setActivatorNodeRef} {...listeners} variant="ghost">
